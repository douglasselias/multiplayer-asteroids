...
cl /nologo /Z7 /diagnostics:caret /sdl /fsanitize=address /Wall /WX /W4 %annoying_warnings% %system_libs% ../main.c /MD /I../vendor /link ../vendor/SDL3.lib ../vendor/SDL3_image.lib /subsystem:windows
